...
class BaseValidator:
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            self.dataloader = self.dataloader or self.get_dataloader(self.data.get(self.args.split), self.args.batch, self.data['multi'])
        ...
        for batch_i, batch in enumerate(bar):
            ...
            # Inference
            with dt[1]:
                preds = model(torch.cat([batch["img_rgb"], batch["img_ir"]], dim=1))
